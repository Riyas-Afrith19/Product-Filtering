const products = [
  ...
  function createProductElement(product){
    ...
    <div class="bg-gray-100 flex justify-center relative overflow-hidden group 
      ...
      <button class="status bg-black text-white absolute bottom-0 left-0 right-0 text-center py-2 
  ...
  function updateCart(e){
    ...
    if(statusEl.classList.contains('added')){
      ...
      statusEl.classList.remove('bg-blue-800');
      ...
      statusEl.classList.add('bg-blue-800');
      cartItemCount++;
    }
  ...
  //Filtr Products by checkboxes and product inputs
  function filterProducts(){
    ...
    productElements.forEach((productElement, index)=>{
      ...
      const isInCheckedCategory = checkedCategories.length === 0 || checkedCategories.includes
      (product.category);
